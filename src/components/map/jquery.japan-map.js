...
(function($){
    ...
    Map.prototype.setData = function(prefecture,area){
        this.data = {
			...
			//description : prefecture? this.getDescription(prefecture) : null,
            area : area? area : null
        };
    };
...
//		console.log(_ua.Pointer + '' + isWinDesktop + '' + _ua.MSPointer + '' + isWinDesktop + '' + _ua.Touch);
